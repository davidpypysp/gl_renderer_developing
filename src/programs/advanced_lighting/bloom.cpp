...
namespace glrd
{
	...
	int BloomProgram()
	{
		...
		Shader shader("5.7.1.bloom.vert", "5.7.1.bloom.frag");
		Shader shaderLight("5.7.1.bloom.vert", "5.7.1.light_box.frag");
		Shader shaderBlur("5.7.1.blur.vert", "5.7.1.blur.frag");
		Shader shaderBloomFinal("5.7.1.bloom_final.vert", "5.7.1.bloom_final.frag");
		...
		// tell OpenGL which color attachments we'll use (or this framebuffer) for rendering
		...
		// ping-poing-framebuffer for bluring
