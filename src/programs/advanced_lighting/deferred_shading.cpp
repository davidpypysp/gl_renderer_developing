...
namespace glrd
{
	...
	int DeferredShading()
	{
		...
		Shader shaderGeometryPass("5.8.1.g_buffer.vert", "5.8.1.g_buffer.frag");
		Shader shaderLightingPass("5.8.1.deferred_shading.vert", "5.8.1.deferred_shading.frag");
		Shader shaderLightBox("5.8.1.deferred_light_box.vert", "5.8.1.deferred_light_box.frag");
