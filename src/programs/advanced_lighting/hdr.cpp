...
namespace glrd
{
	...
	int HdrProgram()
	{
		...
		// --------------------
		GLFWwindow *window = glfwCreateWindow(mWidth, mHeight, "HDR", NULL, NULL);
		if (window == NULL)
		{
		...
		// -------------------------
		Shader shader("5.6.1.lighting.vert", "5.6.1.lighting.frag");
		Shader hdrShader("5.6.1.hdr.vert", "5.6.1.hdr.frag");
