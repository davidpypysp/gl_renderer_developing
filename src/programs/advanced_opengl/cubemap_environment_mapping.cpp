...
namespace glrd
{
    unsigned int loadCubemap(std::vector<std::string> faces)
    {
        ...
        for (unsigned int i = 0; i < faces.size(); i++)
        {
            ...
            if (data)
            {
                ...
                std::cout << "loaded cubemap: " << faces[i] << std::endl;
    ...
    int CubemapEnvironmentMapping()
    {
        ...
        Shader shader("4.6.2.cubemaps.vert", "4.6.2.cubemaps.frag");
        Shader skybox_shader("4.6.1.skybox.vert", "4.6.1.skybox.frag");
        ...
        unsigned int cube_texture = Model::TextureFromFile("container2.png", "resources");
